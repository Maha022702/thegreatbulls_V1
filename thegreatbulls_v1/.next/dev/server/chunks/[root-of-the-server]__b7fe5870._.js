...
"[project]/Documents/Projects/thegreatbulls-react/thegreatbulls_v1/src/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$thegreatbulls$2d$react$2f$thegreatbulls_v1$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                email
            }
        });
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$thegreatbulls$2d$react$2f$thegreatbulls_v1$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$thegreatbulls$2d$react$2f$thegreatbulls_v1$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.create({
            data: {
                name,
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b7fe5870._.js.map